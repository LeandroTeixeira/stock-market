...
_Nota: se a rota GET investimentos/:id estiver demorando demais para ser executada, pode ser necessário apertar Enter no Anaconda Prompt. Este problema é causado por problemas de versão entre o sci-kit Learn instalado no processo e o utilizado no desenvolvimento._
